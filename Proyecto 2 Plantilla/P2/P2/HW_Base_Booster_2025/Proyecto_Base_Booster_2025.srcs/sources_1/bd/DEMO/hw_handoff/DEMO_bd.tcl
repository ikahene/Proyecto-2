...
################################################################
# This is a generated script based on design: DEMO
#
...
proc create_root_design { parentCell } {
  ...
  set RS [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 RS ]

  set RST [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 RST ]
  ...
  set BTN_JY [ create_bd_port -dir I BTN_JY ]
  set BUZZER_PWM [ create_bd_port -dir O BUZZER_PWM ]
  ...
  # Create instance: BUZZER_0, and set properties
  set block_name BUZZER
  set block_cell_name BUZZER_0
  if { [catch {set BUZZER_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  # Create instance: CANDYMAN_FSM_0, and set properties
  set block_name CANDYMAN_FSM
  set block_cell_name CANDYMAN_FSM_0
  if { [catch {set CANDYMAN_FSM_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $CANDYMAN_FSM_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports RS] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports RST] [get_bd_intf_pins axi_gpio_0/GPIO2]
  ...
  connect_bd_net -net BTN0_0_1 [get_bd_ports BTN0] [get_bd_pins BUZZER_0/BTN0]
  connect_bd_net -net BTN1_0_1 [get_bd_ports BTN1] [get_bd_pins BUZZER_0/BTN1]
  connect_bd_net -net BTN_JY_0_1 [get_bd_ports BTN_JY] [get_bd_pins vio_0/probe_in0]
  connect_bd_net -net BUZZER_0_BUZZER_PWM [get_bd_ports BUZZER_PWM] [get_bd_pins BUZZER_0/BUZZER_PWM]
  connect_bd_net -net BUZZER_0_LEDS [get_bd_ports LEDS] [get_bd_pins BUZZER_0/LEDS]
  connect_bd_net -net CANDYMAN_FSM_0_frecuencia_out [get_bd_pins BUZZER_0/TONO] [get_bd_pins CANDYMAN_FSM_0/frecuencia_out] [get_bd_pins ila_0/probe0]
  ...
  connect_bd_net -net clk_0_1 [get_bd_ports clk] [get_bd_pins BUZZER_0/clk] [get_bd_pins CANDYMAN_FSM_0/clk] [get_bd_pins ila_0/clk] [get_bd_pins vio_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_quad_spi_1/ext_spi_clk] [get_bd_pins axi_quad_spi_1/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_1/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins BUZZER_0/BTN_JY] [get_bd_pins CANDYMAN_FSM_0/rst] [get_bd_pins vio_0/probe_out0]
