...
HD_PWD='C:/SEP_vitis/P2/Proyecto 2 Plantilla/P2/P2/HW_Base_Booster_2025/Proyecto_Base_Booster_2025.runs/DEMO_BUZZER_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DEMO_BUZZER_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DEMO_BUZZER_0_0.tcl
