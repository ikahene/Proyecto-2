...
HD_PWD='C:/SEP_vitis/P2/Proyecto 2 Plantilla/P2/P2/HW_Base_Booster_2025/Proyecto_Base_Booster_2025.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DEMO_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DEMO_wrapper.tcl
